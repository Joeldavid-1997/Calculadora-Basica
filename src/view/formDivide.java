...
import controller.ControllerDivide;

/**
 *
 * @author joarevalos
 */
public class formDivide extends javax.swing.JPanel {

    ControllerDivide controller;

    public formDivide() {
        initComponents();
        
        controller = new ControllerDivide(this);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DIVISIÓN DE VALORES");
