...
import controller.ControllerResta;

/**
 *
 * @author joarevalos
 */
public class formResta extends javax.swing.JPanel {

    ControllerResta controller;
    
    public formResta() {
        initComponents();
                
        controller = new ControllerResta(this);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SUSTRACIÓN DE VALORES");
